...
df = pd.read_csv("/home/mpaul/projects/mpaul/mai/data/solana_2023c_data_nfs_extract/temp/solana_2023c_7apps_non_norm_v2.csv")
...
seq_features = ['splt_piat', 'splt_ps', 'splt_direction']
...
ps_stacked = np.vstack(df['splt_ps'])
# print(ps_stacked)
piat_stacked = np.vstack(df['splt_piat'])
...
# print(df['splt_ps'])
# print(df['splt_ps'][0].tolist())
# print(type(df['splt_ps'][0]))

# df1 = pd.read_parquet('/home/mpaul/projects/mpaul/mai/data/standard_scaler/final_train_test/test_dalhousie_nims_7app_nfs_normalized.parquet')
...
# df.to_csv("/home/mpaul/projects/mpaul/mai/data/solana_2023c_data_nfs_extract/2023c_Mobile_LTE_nfs_extract_v2_normalized_vtemp2.csv")
...
df.to_csv("/home/mpaul/projects/mpaul/mai/data/solana_2023c_data_nfs_extract/temp/solana_2023c_7apps_norm_v3.csv")
df.to_parquet("/home/mpaul/projects/mpaul/mai/data/solana_2023c_data_nfs_extract/temp/solana_2023c_7apps_norm_v3.parquet")
