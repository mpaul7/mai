...
# =============== DL Models ===================== 
clf_type='dl'
test_model='/home/mpaul/projects/mpaul/mai/models_dec09/mlp_cnn_tl_20_20241210090835.h5'
...
# python3 src_3/cli.py ${clf_type} test ${test_model} ${dl_config_file} ${test_file}
