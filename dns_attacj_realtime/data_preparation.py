...
class DataPreparation:
    ...
    def bucketize_data(self, bucket_size=30, df=None):
        ...
        # df['pkt_per_sec'] = (df['pkt_fwd_count'] + df['pkt_bwd_count']) / df['total_time']
        # df['pkt_bytes_per_sec'] = (df['pkt_len_fwd_total'] + df['pkt_len_bwd_total']) / df['total_time']
        ...
        df['first_timestamp'] = (df['first_timestamp'] // 1_000).astype(int)
        ...
        output_col = ['sip', 'sport', 'dip', 'dport', 'bucket', 'first_timestamp', 'time_difference_seconds',
                      'pkt_bwd_count','pkt_fwd_count', 'pkt_len_fwd_total', 'pkt_len_bwd_total',
                     'pl_fwd_count','pl_bwd_count', 'pl_len_fwd_total', 'pl_len_bwd_total',
                     'label', 
                    # 'flow_fwd_count', 'flow_bwd_count', 'flow_count_ratio',
                    # 'filename'
                    ]
