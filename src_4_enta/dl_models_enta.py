    ...
    def _build_model_branches(self) -> dict:
        ...
        if len(model_types) > 0:
            for model_type in model_types:
                ...
                if model_type == 'lstm':
                    inputs, layers = utils_dl_enta.create_dl_model_lstm(self.params)
                elif model_type == 'mlp':
                    inputs, layers = utils_dl_enta.create_dl_model_mlp(self.params)
                elif model_type == 'cnn':
                    inputs, layers = utils_dl_enta.create_dl_model_cnn(self.params)
    ...
    def _create_final_model(self, input_branches: dict) -> Model:
        ...
        for i in range(self.params["num_encoder_dense"]):
            x = layers.Dense(units=self.params["encoder_dense_units_list"][i], 
                            kernel_initializer=utils_dl_enta.KERAS_INITIALIZER[self.params["initializer"]],
...
class ModelBuilderTransferLearning:
    ...
    def _create_final_model(self) -> Model:
        ...
        # model # 8
        # base_a = load_model('/home/mpaul/projects/mpaul/mai/models/models_jan10/1_mlp_120_7e-05_20250113080551.h5')
        # base_b = load_model('/home/mpaul/projects/mpaul/mai/models/models_jan10/2_lstm_120_7e-05_20250113073105.h5')
        ...
        # model # 10
        base_a = load_model('/home/mpaul/projects/mpaul/mai/models/models_jan10/2_lstm_120_7e-05_20250113073105.h5')
        base_b = load_model('/home/mpaul/projects/mpaul/mai/models/models_jan10/4_cnn_100_stat_7e-05_20250112212157.h5')
        ...
        partial_model_a = Model(inputs=base_a.input, outputs=base_a.layers[13].output)  
        partial_model_b = Model(inputs=base_b.input, outputs=base_b.layers[26].output) 
...
class DLModels:
    ...
    def __init__(self, train_file: str, params: dict, model_arch: Model, test_file: str, trained_model_file: str):
        ...
        self.model = tf.keras.models.model_from_json(model_arch) #model_arch
        self.params = params
    ...
    def train_model(self) -> Model:
        ...
        """ Prepare datasets """
        train_dataset, val_dataset = utils_dl_enta.create_train_test_dataset_tf(
    ...
    def test_model(self):
        ...
        """Create test dataset"""
        test_dataset = utils_dl_enta.create_train_test_dataset_tf(
        ...
        matrix = utils_dl_enta.getClassificationReport(
